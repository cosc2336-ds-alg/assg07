 ...
 */
/*
TEST_CASE("<append> member function tests",
          "[task1append]")
{
 ...
 */
/*
TEST_CASE("< operator>> > overloaded operator tests",
          "[task1overloadedOperator]")
{
  SECTION("grow an initially empty list")
  {
    List l1;
 ...
 */
/*
TEST_CASE("<prepend> member function tests",
          "[task2prepend]")
{
  SECTION("grow an initially empty list")
  {
 ...
 */
/*
TEST_CASE("< operator<< > overloaded operator prepend tests",
          "[task2overloadedOperator]")
{
  SECTION("grow an initially empty list")
  {
    List l1;
 ...
 */
/*
TEST_CASE("<concatenate> concatenate member function tests",
          "[task3concatenate]")
{
 ...
 */
/*
TEST_CASE("< operator+ > overloaded concatenate operator tests",
          "[task3overloadedOperator]")
{
  SECTION("concatenation of two empty lists should result in an empty list.")
  {
    List l1;
